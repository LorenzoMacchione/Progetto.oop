...
public boolean tester(Test t, Tweet tweet) {
	...
	Object o = null;
	try {
		m = tweet.getClass().getMethod("get"+t.getArg().substring(0, 1).toUpperCase()+t.getArg().substring(1),null);
		o=m.invoke(tweet);
	...
	else return FilterUtils.check(o, t.getOperetor(), t.getObj());
...
return false;
	...
	public boolean filter(Tweet t) {
		...
		if (and) {return and(t);}
		else if (or) {return or(t);}
		else return tester(singleTest,t);
